...
<head>
    ...
    <title>toko apple </title>
    <link rel="website icon"href="https://www.pngwing.com/id/free-png-neayz"/>
...
<body>
    <div id="nav">
        ...
        <ul>
            <li><a href="#"><i class="ri-apple-fill"></i> Store</a></li>
            <li><a href="#"><i class="ri-product-fill"></i> Produk</a></li>
            <li><a href="#"><i class="ri-information-fill"></i> Tentang Kami</a></li>
            <li><a href="#"><i class="ri-hand-heart-fill"></i> Support</a></li>
        </ul>
